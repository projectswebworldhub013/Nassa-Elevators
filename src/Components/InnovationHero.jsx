// src/components/InnovationHero.jsx
...
import bg from "../assets/images/about5.jpg";
    ...
    >
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 md:px-8 max-w-4xl">
        ...
        <div className="flex items-center justify-center gap-4 mb-5">
          <div className="h-px w-14 bg-[#8EE6A1]" />
        ...
        >
          Innovation is at the heart of Nassa Elevators. From advanced engineering
          to intelligent mobility solutions, we continuously push boundaries to
          create elevators that are smarter, safer, and future-ready.
        </p>

        {/* Value Strip */}
        <div className="mt-6 flex items-center justify-center gap-6 text-xs sm:text-sm tracking-wide uppercase text-white/90">
          {["Technology", "Engineering", "Future-Ready"].map((item) => (
        ...
        <div className="mt-10 flex justify-center">
          ...
          >
            Explore Our Innovations <FaArrowRight />
          </Link>
        </div>
